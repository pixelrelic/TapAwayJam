...
{
    internal class SwEditorCallbacks : AssetModificationProcessor, IPreprocessBuildWithReport
    {
        #region --- Construction ---
        ...
        {
            // Since this class has children, they also trigger OnPreprocessBuild.
            // This check prevents executing the method for subclass instances.
            if (SwReflectionUtils.IsSubclass(this,typeof(SwEditorCallbacks))) return;
            
            UpdateRequiredDefineSymbols();
            SwPreBuildVersions.OnPreprocessBuild(report);
        }
        ...
        {
            SwAccountUtils.TryToRestoreLoginStatus();
