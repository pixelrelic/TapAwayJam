...
namespace SupersonicWisdomSDK.Editor
{
    internal static class SwSelfUpdate
    {
        ...
        private static bool ShouldAbortUpdate(bool isInitiatedByUser, long updatedVersionId)
        {
			...
			SwEditorLogger.Log("Update is needed, proceeding with update");
            SwEditorTracker.TrackEditorEvent(nameof(ShouldAbortUpdate), ESwEditorWisdomLogType.SelfUpdate, ESwEventSeverity.Info, "Update is needed, proceeding with update");
